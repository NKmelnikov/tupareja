...
?>
	...
	<div id="Content" class="container">
      ...
      <article class="la1-article">
        ...
        Все наши мужчины, из Европы и Америки, наш центральный офис находится в г. Барселона и мы хорошо знаем характер,
        ...
        <ul>
          <li>
            ...
            перевод на испанский и английский языки, конфиденциальность ваших  данных
            - основной приоритет в нашей работе.
          </li>
          <li>
            После размещения вашей анкеты на сайте ( или в закрытой базе данных,
            по вашему желанию), мы предлагаем ваше портфолио мужчинам, а также
            высылаем вам, через What's App, Viber, Telegram.
          </li>
          <li>
            В случае, если вы оба заинтересованы продолжать знакомства, на более серьезном уровне,
            по вашему желанию, мужчина приедет к вам в вашу страну и мы организуем уже личную встречу,
            либо вы можете приехать в Европу, все расходы по перелёту и размещению и пребыванию
          ...
          <li>
            Как в своей стране так и во время нахождения на территории Европы и Америки,
            у вас будет постоянный контакт с агенством, если возникнут какие-то вопросы.
          </li>
           <li>
            Мы работаем напрямую с мужчинам, без посреднических агентств. К нам обращаються мужчины из разных стран, зачастую это Европа, в частности Испания, а также Америка, из разных источников, по рекомендации, по рекламе и тд, наш главный офис расположен в предместье Барселоны. Мы обрабатываем заявку мужчины и подбираем девушек согласно запросу. Часто мы делаем опрос в сторис и в ленте, предлагаем анкету всех желающих и так же мужчина самостоятельно в праве выбирать девушку на сайте. После чего мы согласовываем с девушкой, есть ли симпатия и хочет ли девушка общаться с предоставленным мужчиной. Девушка, так же как и мужчина может общаться с несколькими кандидатурами. Самое привлекательное то,что у нас нет переписок через сайт. Вы можете сразу напрямую начать общениес мужчиной. Вы платите единоразовый символический взнос за вступление в наше агентство (15€) и за уникальную возможность встретить свою вторую половинку.
          </li>
        </ul>
        <br>
        <p>Милые девушки, будьте открытыми и уверенными в себе, потому что вы лучшие!</p>
        Международное агентство знакомств “Твоя испанская пара» организовывает ивенты знакомств с
        ...
        подписывайтесь на наш аккаунт в Инстраграм tvoya_ispanskaya_para и следите за всеми новостями,
...
Если у вас есть возможность, выделите для себя время и сделайте новые фото, специально для вашего портфолио, на сайте tuparejaucraniana.com
        ...
        <ul>
          ...
          <li>С животными, вы же не ищите пару верблюду, попугаю, лошади или вашей собаке.</li>
          <li>Фото в шапках, куртках или дубленках, в длинных бесформенных, тяжёлых платьях, ну вы реально думаете, что такой образ может привлечь мужчину или у них нет своих симпатичных женщин.</li>
          <li>Фото за трапезой, с салатами, фрикадельками, картошкой и вином на первом плане, фото с бокалами тоже нежелательны.</li>
          <li>Фото где вы смотрите в пол, вдаль, в сторону, взгляд только в камеру.</li>
				...
				<section class="la1-input-section">
					<div class="la1-input-section__first-box">
						...
						<div class="la1-email-container">
							...
							<div class="la1-color-box">
								<input type="text" required name="la1-instagram" id="la1-instagram" maxlength="50" class="la1-input" placeholder="Ссылка на профиль в инстаграм*">
								<span class="error-box error-la1-instagram"></span>
							</div>
						</div>
