...
<div class="sp1-wrapper sp-wrapper">
  <h1 class="sp-title"><?php _e('service_title_4', 'betheme') ?></h1>
  <div class="sp-img-box">
    <img class="sp-image sp-image1" src="<?= $pathToCustom . '_static/img/service/service_4.jpg?v=' . $v ?>" alt="">
  </div>
  <article>
      <?php _e('service_article_4', 'betheme') ?>
  </article>
</div>
<?php get_footer();
?>
