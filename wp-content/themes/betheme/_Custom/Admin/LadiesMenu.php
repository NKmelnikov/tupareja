          ...
          <script>
            $(function () {
              $("#slider-range").slider({
                ...
                values: [<?php if (isset($_GET['ladiesMinAge']) && ($_GET['ladiesMinAge'] != "")) {
                    echo $_GET['ladiesMinAge'];
                } else {
                    echo $this->ladiesApplicationAdmin->get_minAge();
                }?>,
                    <?php if (isset($_GET['ladiesMaxAge']) && ($_GET['ladiesMaxAge'] != "")) {
                    echo $_GET['ladiesMaxAge'];
                } else {
                    echo $this->ladiesApplicationAdmin->get_maxAge();
                }?>],
              ...
              <div class="meta-box-sortables ui-sortable">
                ...
                <script>
                  $(function () {
                    ...
                    let url = `${document.location.origin}${document.location.pathname}?page=ladies_applications`;
                    if (document.location.search.includes('old_position')) {
