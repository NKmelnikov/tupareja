...
$uploader->allowedExtensions = array('jpeg','jpg','bmp','png','svg'); // all files types allowed by default
...
$uploader->chunksFolder = "/wp-content/uploads";
...
// for delete file requests
    ...
    $result = $uploader->handleDelete(UPLOAD_DIR);
    echo json_encode($result);
}
else {
