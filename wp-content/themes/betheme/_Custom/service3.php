...
<div class="sp1-wrapper sp-wrapper">
  <h1 class="sp-title"><?php _e('service_title_3', 'betheme') ?></h1>
  <div class="sp-img-box">
    <img class="sp-image sp-image1" src="<?= $pathToCustom . '_static/img/service/service_3.jpg?v=' . $v ?>" alt="">
  </div>
  <article>
      <?php _e('service_article_3', 'betheme') ?>
  </article>
</div>
<?php get_footer();
?>
